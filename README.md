...
| 📱 [Mobile](mobile/) | Aplicação mobile | [📖](mobile/README.md) |
| 🗄️ [Database](database/) | Esquemas, migrations, seeds | [📖](database/README.md) |
| 📚 [Docs](docs/) | Documentação técnica completa | [📖](docs/README.md) |
| 🧪 [Tests](tests/) | Testes E2E e de integração | [📖](tests/README.md) |
| 🔧 [DevOps](devops/) | CI/CD, containerização | [📖](devops/README.md) |
| ⚙️ [Scripts](scripts/) | Automação e utilitários | [📖](scripts/README.md) |
| 🔐 [Config](config/) | Configurações de ambiente | [📖](config/README.md) |
| 🎭 [Assets](assets/) | Recursos estáticos | [📖](assets/README.md) |
